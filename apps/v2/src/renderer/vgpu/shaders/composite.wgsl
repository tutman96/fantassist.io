...
@fragment fn fs_main(@location(0) uv: vec2f) -> @location(0) vec4f {
  ...
  let fog_or_wall_color = mix(fog_interaction_color, vec3f(1.4, 0.72, 0.08), params.interaction_wall);
  let interaction_color = mix(fog_or_wall_color, vec3f(0.18, 0.92, 1.0), params.interaction_effect);
